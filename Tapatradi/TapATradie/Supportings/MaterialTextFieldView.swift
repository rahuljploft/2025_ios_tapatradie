...
class MaterialTextFieldView: UIView {
    ...
    var textColor = UIColor.hexColor(0x343432)
    
    var textFieldBackgroundColor = UIColor.clear
    
    var placeHolderColor = UIColor.hexColor(0x696969)
    var borderColor = UIColor.hexColor(0xB0B0B0)
    var messageColor = UIColor.hexColor(0x90908E)
    
    var messageErrorColor = UIColor.hexColor(0xC11B1B)
    var borderErrorColor = UIColor.hexColor(0xC11B1B)
    var placeHolderErrorColor = UIColor.hexColor(0xC11B1B)
