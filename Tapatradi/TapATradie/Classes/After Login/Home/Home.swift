...
extension Home: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, HomeCellDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.viewBackground.border(UIColor.hexColor(0xEC9422), 0, 1)
    ...
    func redirectToTradieMap(ob: Services?){
