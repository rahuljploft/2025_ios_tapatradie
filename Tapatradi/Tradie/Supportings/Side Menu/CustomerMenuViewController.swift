...
@objc protocol SideMenuDelegate{
    @objc optional func menuClicked (_ vc: String)
}

let Key_Menu_VC_RateReview = "Key_Menu_VC_RateReview"
...
let Key_Menu_VC_Payment = "Key_Menu_VC_Payment"
...
class CustomerMenuViewController: UIViewController, FloatRatingViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        imgProfilePicture.image = #imageLiteral(resourceName: "default images")
        ...
        //imgProfilePicture.uiimage(url, "Group 2826", true, nil)
    }
    ...
    @IBAction func actionRateReview(_ sender: Any) {
        self.dismiss(animated: true, completion: nil)
        delegate?.menuClicked!(Key_Menu_VC_RateReview)
    }
    ...
    @IBAction func actionPayment(_ sender: Any) {
        self.dismiss(animated: true) {
            self.delegate?.menuClicked!(Key_Menu_VC_Payment)
        }
    ...
    @IBAction func actionLogout(_ sender: Any) {
        ...
        let ok = UIAlertAction(title: "Logout", style: .default, handler: { (action) -> Void in
            self.dismiss(animated: true, completion: nil)
            self.delegate?.menuClicked!(Key_Menu_VC_Logout)
        })
    ...
    /*@IBAction func myParkingBtnClicked(_ sender: Any) {
        self.dismiss(animated: true, completion: nil)
        delegate?.CommonfunctionForSideMenuDelegate!(text:"parking")
    }*/
