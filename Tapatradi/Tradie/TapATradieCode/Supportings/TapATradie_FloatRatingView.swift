...
@objc public protocol TapATradie_FloatRatingViewDelegate {
    /// Returns the rating value when touch events end
    @objc optional func floatRatingView(_ ratingView: TapATradie_FloatRatingView, didUpdate rating: Double)

    /// Returns the rating value as the user pans
    @objc optional func floatRatingView(_ ratingView: TapATradie_FloatRatingView, isUpdating rating: Double)
}

/// A simple rating view that can set whole, half or floating point ratings.
@IBDesignable
@objcMembers
open class TapATradie_FloatRatingView: UIView {
    
    // MARK: Properties
    
    open weak var delegate: TapATradie_FloatRatingViewDelegate?
