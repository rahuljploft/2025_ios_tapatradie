...
//                parsedData = output.TapATradie_getMutable(nil) ?? (Any).self
...
//        } else {
//            TapATradie_ActivityIndicator.shared.showLoader()
//        }
//    }
...
//        } else {
//            TapATradie_ActivityIndicator.shared.stopLoader()
//        }
//    }
...
//                                    if index == 0 {
//                                        vcc?.TapATradie_alertZero()
//                                    } else if index == 1 {
//                                        vcc?.TapATradie_alertOne()
//                                    }
//        })
//        return action
//    }
