...
//                mdd?[arr[iii]] = val.TapATradie_getMutable(nil)
...
//            if str.count == 1 {
//                str = TapATradie_logicIf (key, str, value)
//            } else {
...
//        }
//    }
//    func TapATradie_logicIf (_ key: String, _ str: String, _ value: Any) -> String {
//        var str = str
//        if value is String {
...
//            str = "\(str)\(key.colon ()):\(val.TapATradie_toString3(false))"
