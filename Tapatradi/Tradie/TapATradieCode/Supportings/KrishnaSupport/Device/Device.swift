...
public extension UIDevice {
    ...
    var TapATradie_modelName: String {
    ...
    public func TapATradie_deviceInfo (_ mdd: NSMutableDictionary?) {
        if mdd != nil {
            mdd?["os_type"] = "ios"
            ...
            mdd?["device_name"] = UIDevice.current.TapATradie_modelName
            mdd?["identifierForVendor"] = TapATradie_identifierForVendor ()
        }
    }
    
    func TapATradie_identifierForVendor () -> String {
        var venderUdid = UIDevice.current.identifierForVendor!.uuidString
        let obb = StoreToDevice()
