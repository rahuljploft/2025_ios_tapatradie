...
public typealias TapATradie_DrawerVoidBlock = () -> ()

@objc
public protocol TapATradie_DrawerTransitionDelegate:NSObjectProtocol {
    @objc optional func canPresentWith(transition:TapATradie_DrawerTransition) -> Bool
    @objc optional func canDismissWith(transition:TapATradie_DrawerTransition) -> Bool
}

@objc
public class TapATradie_DrawerTransition: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIGestureRecognizerDelegate {
    ...
    private var presentBlock:TapATradie_DrawerVoidBlock?
    private var dismissBlock:TapATradie_DrawerVoidBlock?
    ...
    @objc
    public func presentDrawerViewController(animated:Bool, completion:TapATradie_DrawerVoidBlock?) {
        guard let drawer = self.drawer   else { return }
        guard canPresent == true         else { return }
        guard isAnimated == false        else { return }
        guard enablePresent == true      else { return }
    ...
    @objc
    public func dismissDrawerViewController(animated:Bool, completion:TapATradie_DrawerVoidBlock?) {
        guard let drawer = self.drawer  else { return }
        guard canDismiss == true        else { return }
        guard isAnimated == false       else { return }
        guard enableDismiss == true     else { return }
    ...
    @objc public func setPresentCompletion(block:TapATradie_DrawerVoidBlock?) { self.presentBlock = block }
    @objc public func setDismissCompletion(block:TapATradie_DrawerVoidBlock?) { self.dismissBlock = block }
}

extension TapATradie_DrawerTransition {
