...
class TapATradie_SupportVC: UIViewController {
...
//        param["page"] = "all"
//        
        Http.instance().json(TapATradie_api_get_category_list, param, "GET", aai: true, popup: true, prnt: true, nil, nil, sync: false, defaultCalling: false) { (json, paras, str, data) in
...
//                    }
    ...
    func supportEnquiry() {
        ...
        guard let userId = UserDefaults.standard.string(forKey: TapATradie_Key_User_id) else{
            return
        }
        ...
        Http.instance().json(TapATradie_api_get_support_enquiry, param, "POST", aai: true, popup: true, prnt: true, nil, nil, sync: false, defaultCalling: false) { (json, paras, str, data) in
...
//
    ...
    func showThankYou(){
        ...
        let vc = storyboard?.instantiateViewController(withIdentifier: "ThankYouVC") as! TapATradie_ThankYouVC
...
extension TapATradie_SupportVC: UITextViewDelegate{
...
extension TapATradie_SupportVC: TapATradie_ThankyouDelegate{
