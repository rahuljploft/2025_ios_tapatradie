...
class TapATradie_UserServices: UIViewController {    
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        txtfld4Search.placeHolderColor(UIColor.TapATradie_hexColor(0x707070), "Search for a Tradie")
...
//        }
    ...
    func getServices (_ page: String) {
        ...
        Http.instance().json(TapATradie_api_get_services_list, param, "POST", aai: true, popup: true, prnt: true, nil, nil, sync: false, defaultCalling: false) { (json, paras, str, data) in
            ...
            if data != nil {
                do {
                    let self_servicesJSON = try JSONDecoder().decode(TapATradie_ServicesJSON.self, from: data!)
    ...
    var arrTable = [TapATradie_Services]()
    var arrDict = [[String:[TapATradie_Services]]]()
    
    func createTableArray () {
        arrTable = [TapATradie_Services]()
        arrDict = [[String:[TapATradie_Services]]]()
        ...
        if self.servicesJSON?.data != nil {
            ...
            var arryService = [TapATradie_Services]()
...
extension TapATradie_UserServices: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, TapATradie_HomeCellDelegate, UITextFieldDelegate {
...
//        return arrTable.count
    ...
    func processJSON (_ servicesJSON: TapATradie_ServicesJSON?) {
...
//            let rows = 15
            ...
            let arrService = serviceDict[serviceDict.keys.first ?? ""] ?? [TapATradie_Services("")]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if fixed_service == "0" {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "USCell", for: indexPath) as! TapATradie_USCell
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader:
            ...
            let headerView = cltnView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "UserServiceHeaderCV", for: indexPath) as! TapATradie_UserServiceHeaderCV
...
class TapATradie_USCell: UICollectionViewCell {
