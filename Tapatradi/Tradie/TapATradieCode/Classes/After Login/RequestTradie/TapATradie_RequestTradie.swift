...
extension TapATradie_RequestTradie: TapATradie_DrawerTransitionDelegate, TapATradie_SideMenuDelegate {
    ...
    func TapATradie_menuClicked (_ vc: String) {
        if vc == Key_Menu_VC_AboutUs {
            ...
            let vc = TapATradie_story_Invite.TapATradie_viewController("SupportVC")
            self.navigationController?.pushViewController(vc!, animated: false)
...
class TapATradie_RequestTradie: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        TapATradie_kAppDelegate.TapATradie_obAddresses = ob
        ...
        btnImmediately.TapATradie_checked(boolImmediately)
        btnChooseDate.TapATradie_checked(boolChooseDate)
        btnResidential.TapATradie_checked(boolResidential)
        btnCommercial.TapATradie_checked(boolCommercial)
        ...
        DispatchQueue.main.asyncAfter(deadline: .now()+3) {
            if TapATradie_kAppDelegate.TapATradie_obAddresses != nil {
                if TapATradie_kAppDelegate.TapATradie_obAddresses?.latitude != nil && TapATradie_kAppDelegate.TapATradie_obAddresses?.longitude != nil {
                    let latitude = (TapATradie_kAppDelegate.TapATradie_obAddresses?.latitude)!
                    let longitude = (TapATradie_kAppDelegate.TapATradie_obAddresses?.longitude)!
    ...
    @IBAction func actionImmediately(_ sender: UIButton) {
        ...
        sender.TapATradie_checked(boolImmediately)
    }
    ...
    @IBAction func actionChooseDate(_ sender: UIButton) {
        ...
        sender.TapATradie_checked(boolChooseDate)
    }
    ...
    @IBAction func actionResidential(_ sender: UIButton) {
        ...
        sender.TapATradie_checked(boolResidential)
    }
    ...
    @IBAction func actionCommercial(_ sender: UIButton) {
        ...
        sender.TapATradie_checked(boolCommercial)
    }
    ...
    @IBAction func actionTimeDone(_ sender: Any) {
        ...
        let hhh = TapATradie_get12HourTime(hh)
        lblTime.text = hhh
    }
    ...
    @IBAction func actionNext(_ sender: Any) {
        ...
        if validation () {
            ...
            if tradies != nil || boolSendToAll {
                ...
                param.TapATradie_addStaticLocation()
                
                param.TapATradie_addSearchType()
                ...
                createPostAPICall(videoData: videoData, imagesData: imgData, imageparam: "images", endPoint: TapATradie_api_user_job_request_to_tradie, param: param as! [String : Any])
            } else {
                if tradies == nil {
                    param["tradie_id"] = "0"
                } else {
...
extension TapATradie_RequestTradie: TapATradie_PlanceApiDelegate {
...
extension TapATradie_RequestTradie: UITextFieldDelegate, UITextViewDelegate {
...
extension UIButton {
    func TapATradie_checked (_ bool: Bool) {
        self.setTitleColor(UIColor.TapATradie_hexColor(0x343432), for: .normal)
        if bool {
            self.layer.borderColor = UIColor.TapATradie_hexColor(0x008000).cgColor
...
extension String {
    func TapATradie_concat (_ add: String?, _ with: String = ",") -> String {
        if add == nil {
            return self
        }
...
extension TapATradie_RequestTradie: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    func openGallary() {
        ...
        if mexImages != 0 {
            ...
            presentOpalImagePickerController(imagePicker, animated: true, select: { (im) in
                ...
                for i in 0..<im.count {
                    let cc = im[i].TapATradie_getAssetThumbnail(CGSize(width: 500, height: 500))
                    imageArr.append(cc!)
                }
...
extension PHAsset {
    func TapATradie_getAssetThumbnail (_ size: CGSize = CGSize(width: 100, height: 100)) -> UIImage? {
...
extension TapATradie_RequestTradie{
...
//            Common.sharedInstance.printMsg(info)
            ...
            if let dic = info as? [String : Any]{
                if let code = dic["code"] as? Int, code == TapATradie_Code.expireToken.rawValue{
...
//                    print(kErrorExpiredToken)
                    ...
                    return
                }else if let code = dic["code"] as? Int, code == TapATradie_Code.maintainenceToken.rawValue {
//                    Common.sharedInstance.hideHud();
...
public enum TapATradie_Code : Int {
    case updateApp                  = 402
...
extension TapATradie_RequestTradie: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "selectedCell_Img", for: indexPath) as! TapATradie_selectedCell_Img
...
class TapATradie_selectedCell_Img: UICollectionViewCell {
