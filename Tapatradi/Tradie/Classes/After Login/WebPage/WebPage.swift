...
enum LinkType {
    case iap_termsncondition
    case iap_privacypolicy
...
class WebPage: UIViewController/*, UIWebViewDelegate*/ {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if linkType == .iap_termsncondition {
            lblHeader.text = "Terms and Conditions"
            url = url_iap_termsandconditions
        } else if linkType == .iap_privacypolicy {
            url = url_iap_privacypolicy
            lblHeader.text = "Privacy Policy"
        } else if linkType == .termsncondition {
            lblHeader.text = "Terms and Conditions"
            url = url_termsandconditions
        ...
        //webPage.loadRequest(URLRequest(url: URL(string: url)!))
